...
#define TAG "XIAOXINESP32S3154WIFI"
...
class XIAOXINESP32S3154WIFI : public WifiBoard {
private:
...
public:
    XIAOXINESP32S3154WIFI() :boot_button_(BOOT_BUTTON_GPIO,true,1500,500), power_key_button_(POWER_KEY_GPIO,true,1500,500), volume_up_button_(VOLUME_UP_BUTTON_GPIO,false,1500,500), volume_down_button_(VOLUME_DOWN_BUTTON_GPIO,false,1500,500) {  
...
DECLARE_BOARD(XIAOXINESP32S3154WIFI);
