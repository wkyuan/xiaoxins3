...
public:
    XIAOXINESP32S31544G() :DualNetworkBoard(ML307_TX_PIN, ML307_RX_PIN, 4096), boot_button_(BOOT_BUTTON_GPIO,true,1500,500), power_key_button_(POWER_KEY_GPIO,true,1500,500), volume_up_button_(VOLUME_UP_BUTTON_GPIO,false,1500,500), volume_down_button_(VOLUME_DOWN_BUTTON_GPIO,false,1500,500) {  
